...
[![Coverage Status](https://coveralls.io/repos/github/http4k/http4k-by-example/badge.svg?branch=master)](https://coveralls.io/github/http4k/http4k-contract-example-app?branch=master)
